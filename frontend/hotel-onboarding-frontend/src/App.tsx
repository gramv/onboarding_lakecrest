...
const EnhancedManagerDashboardComponent = lazy(() => import('@/components/dashboard/EnhancedManagerDashboard'))
        ...
        <Router>
          <div className="min-h-screen bg-gray-50">
            <Suspense fallback={<PageLoader />}>
              ...
              {/* Manager Dashboard Routes with nested routing (Legacy) */}
              <Route path="/manager-basic" element={
                <ProtectedRoute requiredRole="manager">
                  <ManagerDashboardLayout />
                </ProtectedRoute>
              }>
                <Route index element={<Navigate to="/manager-basic/applications" replace />} />
