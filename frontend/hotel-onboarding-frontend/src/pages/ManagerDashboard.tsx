    ...
    <ErrorBoundary>
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="space-y-6">
          ...
          {loading ? (
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,4fr)_minmax(0,2fr)] gap-6">
              ...
              <Card className="bg-white shadow-sm border border-slate-200/70 rounded-2xl lg:col-span-1">
                <CardHeader className="flex flex-col gap-2 border-b border-slate-100/80 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-xl font-semibold text-slate-800">{property.name}</CardTitle>
                  </div>
                ...
                <CardContent className="pt-5 pb-6 space-y-5">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="flex items-start gap-3">
                      <span className="mt-1 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-slate-100 text-slate-500">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-600">{property.phone || 'Not provided'}</p>
                      </div>
                    </div>
                  </div>
          ...
          <TabsContent value="settings">
            <div className="space-y-6">
              <Card className="card-elevated card-rounded-md">
                ...
                <CardContent className="card-padding-md flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div>
                    <h4 className="font-medium">Password</h4>
                    <p className="text-sm text-muted-foreground">Update your password regularly to protect access.</p>
                  </div>
              ...
              <Card className="card-elevated card-rounded-md">
                <CardHeader className="card-padding-md border-b border-muted">
                  <CardTitle className="text-heading-md">Application notifications</CardTitle>
                  <CardDescription>Control who receives emails for new submissions and status changes.</CardDescription>
                </CardHeader>
              ...
              {property && (
                <Card className="card-elevated card-rounded-md">
                  <CardHeader className="card-padding-md border-b border-muted">
                    <CardTitle className="text-heading-md">Property tools</CardTitle>
                    <CardDescription>Quick actions for {property.name}.</CardDescription>
                  </CardHeader>
                  <CardContent className="card-padding-md space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 border rounded-lg">
                      <div>
                        <h4 className="font-medium">QR code</h4>
                        <p className="text-sm text-muted-foreground">Regenerate the application QR code after printing new materials.</p>
                      </div>
                      <Button variant="outline" onClick={regenerateQrManually}>
                        <RefreshCw className="h-4 w-4 mr-2" />
                        Regenerate QR code
                      </Button>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Download spreadsheets of current applications and staff.</p>
                      </div>
