...
import { 
  ...
  AlertCircle, CheckCircle, Calculator, Compare,
  Heart, Eye, Tooth, ArrowRight, ChevronDown, ChevronUp
} from 'lucide-react'
import {
  Tooltip,
  TooltipContent,
...
export default function HealthInsuranceFormEnhanced({
  initialData = {},
  personalInfo,
  language,
  onSave,
        ...
        <CardContent className="space-y-3">
          <div className="space-y-2">
            ...
            {formData.dentalCost > 0 && (
              <div className="flex justify-between items-center text-sm">
                <span className="flex items-center">
                  <Tooth className="h-3 w-3 mr-1 text-blue-500" />
                  Dental
                </span>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              <Tooth className="h-5 w-5 text-blue-500" />
              <div>
